...
proc create_root_design { parentCell } {
  ...
  # Create instance: axi_control_intercon, and set properties
  set axi_control_intercon [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 axi_control_intercon ]

  # Create instance: axi_mem_intercon, and set properties
  set axi_mem_intercon [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 axi_mem_intercon ]
  set_property -dict [ list CONFIG.NUM_MI {1} CONFIG.NUM_SI {2}  ] $axi_mem_intercon

  # Create instance: axi_vdma_img_proc, and set properties
  set axi_vdma_img_proc [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_vdma:6.2 axi_vdma_img_proc ]
  set_property -dict [ list CONFIG.c_m_axis_mm2s_tdata_width {24} CONFIG.c_num_fstores {1}  ] $axi_vdma_img_proc
...
CONFIG.PCW_FCLK_CLK0_BUF {true} CONFIG.PCW_FPGA0_PERIPHERAL_FREQMHZ {100} \
...
CONFIG.PCW_SD1_GRP_CD_ENABLE {1} CONFIG.PCW_SD1_GRP_WP_ENABLE {0} \
...
CONFIG.PCW_TTC0_CLK0_PERIPHERAL_CLKSRC {CPU_1X} CONFIG.PCW_TTC0_CLK1_PERIPHERAL_CLKSRC {CPU_1X} \
CONFIG.PCW_TTC0_CLK2_PERIPHERAL_CLKSRC {CPU_1X} CONFIG.PCW_TTC0_PERIPHERAL_ENABLE {1} \
...
CONFIG.PCW_USE_S_AXI_HP0 {1} CONFIG.preset {Default*} \
  ...
  connect_bd_intf_net -intf_net S00_AXI_1 [get_bd_intf_pins axi_control_intercon/S00_AXI] [get_bd_intf_pins processing_system7_0/M_AXI_GP0]
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins axi_control_intercon/M00_AXI] [get_bd_intf_pins axi_vdma_img_proc/S_AXI_LITE]
  connect_bd_intf_net -intf_net axi_mem_intercon_M00_AXI [get_bd_intf_pins axi_mem_intercon/M00_AXI] [get_bd_intf_pins processing_system7_0/S_AXI_HP0]
  connect_bd_intf_net -intf_net axi_vdma_0_M_AXI_MM2S [get_bd_intf_pins axi_mem_intercon/S00_AXI] [get_bd_intf_pins axi_vdma_img_proc/M_AXI_MM2S]
  connect_bd_intf_net -intf_net axi_vdma_img_proc_M_AXIS_MM2S [get_bd_intf_pins axi_vdma_img_proc/M_AXIS_MM2S] [get_bd_intf_pins axi_vdma_img_proc/S_AXIS_S2MM]
  connect_bd_intf_net -intf_net axi_vdma_img_proc_M_AXI_S2MM [get_bd_intf_pins axi_mem_intercon/S01_AXI] [get_bd_intf_pins axi_vdma_img_proc/M_AXI_S2MM]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_control_intercon/ACLK] [get_bd_pins axi_control_intercon/M00_ACLK] [get_bd_pins axi_control_intercon/M01_ACLK] [get_bd_pins axi_control_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins axi_vdma_img_proc/m_axi_mm2s_aclk] [get_bd_pins axi_vdma_img_proc/m_axi_s2mm_aclk] [get_bd_pins axi_vdma_img_proc/m_axis_mm2s_aclk] [get_bd_pins axi_vdma_img_proc/s_axi_lite_aclk] [get_bd_pins axi_vdma_img_proc/s_axis_s2mm_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins rst_processing_system7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_processing_system7_0_100M/ext_reset_in]
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_aresetn [get_bd_pins axi_control_intercon/ARESETN] [get_bd_pins axi_control_intercon/M00_ARESETN] [get_bd_pins axi_control_intercon/M01_ARESETN] [get_bd_pins axi_control_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins axi_vdma_img_proc/axi_resetn] [get_bd_pins rst_processing_system7_0_100M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x40000000 -offset 0x0 [get_bd_addr_spaces axi_vdma_img_proc/Data_MM2S] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_processing_system7_0_HP0_DDR_LOWOCM
  create_bd_addr_seg -range 0x40000000 -offset 0x0 [get_bd_addr_spaces axi_vdma_img_proc/Data_S2MM] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_processing_system7_0_HP0_DDR_LOWOCM
  create_bd_addr_seg -range 0x10000 -offset 0x43000000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_vdma_img_proc/S_AXI_LITE/Reg] SEG_axi_vdma_img_proc_Reg
