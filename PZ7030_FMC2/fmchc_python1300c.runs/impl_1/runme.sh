...
HD_PWD='C:/Avnet/hdl/Projects/fmchc_python1300c/PZ7030_FMC2/fmchc_python1300c.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fmchc_python1300c_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fmchc_python1300c_wrapper.tcl -notrace
