...
--Command     : generate_target picozed_hdmi_in_wrapper.bd
--Design      : picozed_hdmi_in_wrapper
...
entity picozed_hdmi_in_wrapper is
  port (
...
end picozed_hdmi_in_wrapper;

architecture STRUCTURE of picozed_hdmi_in_wrapper is
  component picozed_hdmi_in is
  port (
...
picozed_hdmi_in_i: component picozed_hdmi_in
     port map (
      DDC_scl_i => ddc_scl_i,
      DDC_scl_o => ddc_scl_o,
      DDC_scl_t => ddc_scl_t,
