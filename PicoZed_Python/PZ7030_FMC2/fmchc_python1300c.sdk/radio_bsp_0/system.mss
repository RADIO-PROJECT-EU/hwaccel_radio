...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = fmc_hdmi_cam_iic_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER DRIVER_VER = 2.0
 PARAMETER HW_INSTANCE = onsemi_python_cam_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER DRIVER_VER = 2.0
 PARAMETER HW_INSTANCE = onsemi_python_spi_0
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = square_check
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = square_check_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = cfa
 PARAMETER DRIVER_VER = 7.0
 PARAMETER HW_INSTANCE = v_cfa_0
END
...
BEGIN LIBRARY
 PARAMETER LIBRARY_NAME = fmc_hdmi_cam_sw
...
BEGIN LIBRARY
 PARAMETER LIBRARY_NAME = onsemi_python_sw
