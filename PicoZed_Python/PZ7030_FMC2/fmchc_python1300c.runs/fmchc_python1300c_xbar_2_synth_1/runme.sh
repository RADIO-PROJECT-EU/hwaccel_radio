...
HD_PWD='C:/Avnet/hdl/Projects/fmchc_python1300c/PZ7030_FMC2/fmchc_python1300c.runs/fmchc_python1300c_xbar_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fmchc_python1300c_xbar_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fmchc_python1300c_xbar_2.tcl
