...
HD_PWD='C:/Avnet/hdl/Projects/fmchc_python1300c/PZ7030_FMC2/fmchc_python1300c.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fmchc_python1300c_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fmchc_python1300c_wrapper.tcl
